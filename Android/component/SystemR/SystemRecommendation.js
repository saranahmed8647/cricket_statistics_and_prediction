...
export default function SystemRecommendation({navigation}){
    ...
    const Team_Handler = () =>
    {
        if(Team_1_name === Team_2_name)
        {
            ...
            alert("You must have to select different teams")
        }
        else
        {
            const team_data = 
            ...
            navigation.navigate('SquadB',{ user: team_data  });
    ...
    return(
      ...
      <View style={styles.container}>
        <Animatable.View style={styles.header} animation="fadeInDownBig">
          <Text style={{color:'white', fontWeight:'bold', fontSize:25}}>System Best Squad Recommendation!</Text>
        </Animatable.View>
