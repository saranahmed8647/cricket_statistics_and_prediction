  ...
  useEffect(() =>
    ...
    const SubmittedFunc = () =>
    {
      ...
      else
      {
        ...
        for(let v =0; v <final_team_squad.length; v++)
        {
          ...
          history.push({
            pathname : '/TeamBPlayer',
            team_data :{
                Team1: Team_1_name,
                Team2: Team_2_name,
                Venue: Venue,
                Toss : Toss,
                Squad1 : final_team_squad   
            }
            } 
          );
    ...
    const DeletePlayer = (Name) =>
    {
      ...
      if(torender)
      {
        ...
        const rendered_Bowlers_Buttons =  Bowlers_List.filter(name => name["Country"] === Team_1_name).map(b => {
          return(
        ...
        const rendered_Batsmen_Buttons =  Batsmen_List.filter(name => name["Country"] === Team_1_name).map(b => {
          return(
    ...
    return ( 
      ...
      <div class="card" style={{marginLeft:'30%',width:'60rem',marginTop:'5%',marginBottom:'5%',display:'flex',flex:1,alignItems:'center',height:'100%'}}>
            ...
            <p style={{marginTop : '5%', marginBottom:'5%', color:'#e60073',fontSize:25,fontWeight:'bold'}}>Team - A Selection : {Team_1_name}</p>
            <p style={{color:'#b30059',fontSize:15,fontWeight:'bold'}}>Select 1 Player to view prediction based on this player ...</p>
...
<div className="ui active inverted dimmer">
  <div className="ui large text loader">Loading Squad 1's Data</div>
</div>
<p></p>
<p></p>   
<p></p>
