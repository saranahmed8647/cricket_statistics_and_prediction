...
return(
    <div style={{height:"100%"}}>
        ...
        <div style={{marginTop:100,marginLeft:'30%',width:'40%',display:'flex',flex:1,alignItems:'center',position:'fixed',flexDirection:'column',border:'1.5px solid #e6e6e6'}}>
            ...
            <button style={{background:"purple",marginBottom:10,fontSize:15,fontWeight:'bold',width:'70%'}} className="ui purple basic button" onClick={() => history.push('/RemoveATeam') } >Remove Single Team</button>
            <button style={{background:"purple",marginBottom:30,fontSize:15,fontWeight:'bold',width:'70%'}} className="ui purple basic button" onClick={() => history.push('/RemoveMultipleTeams') }>Remove All Teams</button>
        </div>
    </div>
);        
