...
import "./RemoveSingleTeam.component.css";
...
const RemoveSingleTeam = () =>  
{
    ...
    const TeamHandler = (e) => 
    {
        ...
        if (name =="") 
        {
            ...
            axios.post('http://localhost:5000/team/deleteone', team_data)
            //   .then(res =>res.data.JSON())
              ...
              .catch(function (error) {
                ...
                alert("Error Deleting the team, going to main menu");
                history.push("/mainmenu");
              });
            }       
    };
...
<div class="ui middle aligned center aligned grid">
  <div class="column">
    <h2 class="ui image header">
      <div class="content">
      Enter the Name of Team you would like to Remove
      </div>
    </h2>
...
export default RemoveSingleTeam; 
