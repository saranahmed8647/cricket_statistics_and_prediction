...
return(
  ...
  <div className="ui column center aligned">
    ...
    <div className="ui message red inverted">
      ...
      <p>You can't View a single Bowler without being logged in, Please Log in</p>
    </div>
...
const TeamHandler = (e) =>
{
    ...
    {
        setTeamDataErrors([...teamDataErrors,"Name must be atleast 6 characters long"]);
    }
    else 
    {
        history.push(`/bowlersDetails/${name.trim()}`)
}
}
    ...
    <form action="post" onSubmit={TeamHandler} class="ui large form">
      <div class="ui stacked secondary  segment">
        <div class="field">
          ...
          <span style={{fontSize:15}}>Enter the bowler's name whose details you would like to see: </span>
          
        <input type="text" name="name" value={name}
                                                   aria-label="name"
                                                   title="Enter the bowler's name"
...
export default ViewSingleBowler;