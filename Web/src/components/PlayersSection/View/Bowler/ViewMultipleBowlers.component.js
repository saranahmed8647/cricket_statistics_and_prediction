    ...
    <table class="table table-striped">
      ...
      <tbody style={{textAlign:"center"}}>
        {items.map((item,index) => (
          <tr key={index}>
            <td>{index + 1}</td>
            <td style ={{"cursor" : "pointer"}} onClick={() =>{history.push(`/bowlersDetails/${item.name}`)}}><strong>{item.name}</strong></td>
...
return(
  ...
  <div className="ui column center aligned">
    ...
    <div className="ui message red inverted">
      ...
      <p>You can't View Bowlers without being logged in, Please Log in</p>
    </div>
...
<div className="ui large text loader">Getting All Bowlers</div>
</div>
<p></p>
<p></p>   
<p></p>
...
export default ViewMultipleBowlers;