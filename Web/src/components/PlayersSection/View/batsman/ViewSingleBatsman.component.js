...
const TeamHandler = (e) =>
{
    ...
    else if (name.length < 6 ) 
    {
        ...
        history.push(`/batsmenDetails/${name.trim()}`)
}
}
    ...
    <form action="post" onSubmit={TeamHandler} class="ui large form">
      <div class="ui stacked secondary  segment">
        <div class="field">
          ...
          <span style={{fontSize:13}}>Enter the batsman's name whose details you would like to see: </span>
          
          <input type="text" name="name" value={name}
                                                   aria-label="name"
                                                   title="Enter the batsman's name"
...
export default ViewSingleBatsman;