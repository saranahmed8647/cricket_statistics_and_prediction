...
const TeamHandler = (e) =>
{
    axios.delete('http://localhost:5000/player/bowlers/delete')
                .then(json =>
                    {   
                        if(json.status == 200)
                        {
              ...
              .catch(function (error) {
                alert("Failed to delete Bowlers !");
                history.push("/mainmenu");
              });
}
...
return(
  ...
  <div className="ui column center aligned">
    ...
    <div className="ui message red inverted">
      ...
      <p>You can't Remove Bowlers without being logged in, Please Log in</p>
    </div>
      ...
      <div class="ui middle aligned center aligned grid">
        <div class="column">
          <h2 class="ui image header">
            <div class="content">
            <span>Are you sure you want to delete data of all the Bowlers?<br/> </span>
...
export default RemoveMultipleBowlers; 
