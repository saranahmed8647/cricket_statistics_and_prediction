...
const RemoveSingleBowler = () =>  
{
    ...
    const TeamHandler = (e) => 
    {
        ...
        if (name =="") 
        {
            ...
            axios.post('http://localhost:5000/player/bowlers/deleteone', team_data)
                .then(json =>
                    {   
                        if(json.status === 200)
                        {
              ...
              .catch(function (error) {
                ...
                alert("Error Deleting the Bowler, going to main menu");
                history.push("/mainmenu");
              });
            }       
    };
    ...
    <form action="post" onSubmit={TeamHandler} class="ui large form">
      <div class="ui stacked secondary  segment">
        <div class="field">
          ...
          <span style={{fontSize:13}}>Enter the Bowler's Name you'd like to delete: </span>
...
export default RemoveSingleBowler; 
