...
const RemoveMultipleAllrounders = () =>  
{
...
const TeamHandler = (e) =>
{
    axios.delete('http://localhost:5000/player/allrounders/delete')
                .then(json =>
                    {   
                        if(json.status == 200)
                        {
              ...
              .catch(function (error) {
                alert("Failed to delete Allrounders !");
                history.push("/mainmenu");
              });
}
...
<div class="ui middle aligned center aligned grid">
  <div class="column">
    <h2 class="ui image header">
      ...
      <span>Are you sure you want to delete data of all the Allrounders?<br/> </span>
...
export default RemoveMultipleAllrounders; 
