...
const RemoveSingleBatsman = () =>  
{
    ...
    const TeamHandler = (e) => 
    {
        ...
        if (name ==="") 
        {
            ...
            axios.post('http://localhost:5000/player/batsmen/deleteone', team_data)
                .then(json =>
                    {   
                        if(json.status == 200)
                        {
              ...
              .catch(function (error) {
                ...
                alert("Error Deleting the Batsman, going to main menu");
                history.push("/mainmenu");
              });
            }       
    };
    ...
    <form action="post" onSubmit={TeamHandler} class="ui large form">
      <div class="ui stacked secondary  segment">
        <div class="field">
          ...
          <span style={{fontSize:13}}>Enter the Batsman's Name you'd like to delete:</span>
...
export default RemoveSingleBatsman; 
