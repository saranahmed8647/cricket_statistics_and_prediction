...
// Getting allrounders
    axios.get('http://localhost:5000/player/bowlers')
              ...
              .catch(function (error) {
                alert("Failed to get Bowlers Data, going to main menu");
...
return(
  ...
  <div className="ui column center aligned">
    ...
    <div className="ui message red inverted">
      ...
      <p>You can't Update a Bowler without being logged in, Please Log in</p>
    </div>
...
// If user is properly logged in
    ...
    <div style={{height:"100%"}} >
        ...
        <div style={{display:"flex",flexDirection : "column",alignItems:'center'}}>
            ...
            (                        
                <div>
                    <button style={{fontSize:15,color:'#00b36b',outline:'none',backgroundColor:'Transparent'}} onClick={() =>{history.push(`/UpdateOneBowler/${team.name}`)}}><strong>{team.name}</strong></button>
                    <hr />
                </div>
            ))}
            </div>
...
export default UpdateBowlersMain;