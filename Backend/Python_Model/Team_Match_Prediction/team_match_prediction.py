...
# results = pd.read_csv(io.BytesIO(uploaded['final_Match_results.csv']))
...
def clean_and_predict(matches, ranking, final, logreg):
    ...
    for i in range(len(pred_set)):
        ...
        if predictions[i] == 1:
            ...
            print("Winner: " + backup_pred_set.iloc[i, 0])
        print("")
# This fucntion will be called from Node, with the Two teams data will be passed here
def starter_fuction():
    
    # Semi = the Two teams to Face Each other
    semi = ["Afghanistan","Pakistan"]
