...
predictions = rf.predict_proba(pred_set)
...
def clean_and_predict(matches, ranking, final, logreg):
    ...
    # Predict!
    predictions = logreg.predict_proba(pred_set)
    final_answer = {}
    for i in range(len(pred_set)):
        ...
        for k in predictions:
            for j in k:
                ...
                prediction_final_values.append(j)
        # if predictions[i] == 1:
        #     # print("Winner: " + backup_pred_set.iloc[i, 1])
        ...
        # Printing the winning percentage for the winning team
        print((max(prediction_final_values * 100)))
        sys.stdout.flush()
