...
def Main(Team_A, Team_B, ground, toss):
    ...
    data_array = [int(ground) , int(toss) , float(result)]
...
# def temp_func(team_1_list, team_2_list,venue,toss):
#     temp_list_1 = json.loads(team_1_list)
#     temp_list_2 = json.loads(team_2_list)

#     print("Venue : " + str(venue))
#     print("Toss : " + str(toss))

#     for k in temp_list_1:
#         print(k["Name"] , k["Country"])
#     for k in temp_list_2:
#         print(k["Name"] , k["Country"])
